...
$pass=" ";
$database="jisna";
$connection=Mysqli_connect('localhost','root','','jisna');
if($connection)
{
...
$sqli="INSERT INTO Railway(name,address,trainno,trainname,journeydate,boardtime)VALUES('$_POST[name]','$_POST[address]','$_POST[trainno]','$_POST[trainname]','$_POST[journeydate]','$_POST[boardtime],)";
